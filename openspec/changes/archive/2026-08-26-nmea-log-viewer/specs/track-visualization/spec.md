...
Visualize GPS position tracks from replayed NMEA epochs on an interactive north-up map (Leaflet in WebView) for spatial debugging of handheld device output.
